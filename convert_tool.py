...
def readallfiles(filelist):
    for i in range(len(filelist)):
        ...
        df = pd.read_excel("./results/" + filelist[i], names=["SlNo.", "REGD.NO", "NAMEOFTHESTUDENT", "Sem", "SUB.CODE", "SUBJECTNAME", "Type", "Credit", "Grade"]) 
        ...
        while(True):
            ...
            if(choice == 1):
                ...
                while(True):
                    ...
                    filelist = listallresultfiles()
                    choiceoffile = int(input("Enter the file number to insert: "))
